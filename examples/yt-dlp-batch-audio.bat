...
:settings
    ...
    set FORMAT=bestaudio[ext=m4a]/bestaudio/best
    ...
    :: options
    set OPTIONS=--ignore-errors --geo-bypass-country JP --embed-thumbnail --embed-metadata --embed-chapters --extract-audio
